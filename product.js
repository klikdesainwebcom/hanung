...
document.getElementById("preview").innerHTML = '<amp-img id="preview_img" layout="responsive" src="'+ xImg +'" class="detail_prod" width="512" height="512" alt="" title="" style="border:1px solid red;"></amp-img>';
...
document.getElementById("preview").innerHTML = '<amp-img id="preview_img" src="'+ xImg1 +'" width="512" height="512" alt="" title="" style="border:1px solid red;"></amp-img>';
...
document.getElementById("preview").innerHTML = '<amp-img id="preview_img" src="'+ xImg2 +'" width="512" height="512" alt="" title="" style="border:1px solid red;"></amp-img>' ;
...
document.getElementById("preview").innerHTML = '<amp-img id="preview_img" src="'+ xImg3 +'" width="512" height="512" alt="" title="" style="border:1px solid red;"></amp-img>' ;
...
document.getElementById("preview").innerHTML = '<amp-img id="preview_img" src="'+ xImg4 +'" width="512" height="512" alt="" title="" style="border:1px solid red;"></amp-img>' ;
});
document.getElementById("pic5").addEventListener("click", function() { 
var xImg5 = document.getElementById("pic5").getAttribute("src");
document.getElementById("preview").innerHTML = '<amp-img id="preview_img" src="'+ xImg5 +'" width="512" height="512" alt="" title="" style="border:1px solid red;"></amp-img>' ;
